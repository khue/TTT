...
namespace I9.USCIS.XQueue.Live {
    ...
    internal class MyConsole {
        ...
        public void Run() {
            ...
            FdblConsole.WriteMessage("Running spUSCIS_XQueue to update cases");
            Sql.spUSCIS_XQueue spUSICS_XQueue = new Sql.spUSCIS_XQueue(_Config.SqlFactory.GetConnectionString());

            int returnCode = spUSICS_XQueue.StartDataReader();
