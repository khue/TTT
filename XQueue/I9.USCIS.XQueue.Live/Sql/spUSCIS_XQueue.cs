...
namespace I9.USCIS.XQueue.Live.Sql {
    ...
    internal class spUSCIS_XQueue : FdblSql {

        #region Constructors

        public spUSCIS_XQueue(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spUSCIS_XQueue", CommandType.StoredProcedure, true);
