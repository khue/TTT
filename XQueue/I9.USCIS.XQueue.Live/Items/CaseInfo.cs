...
namespace I9.USCIS.XQueue.Live.Items {
    ...
    internal class CaseInfo {
        ...
        private string _ResolutionCode = null;
        ...
        internal CaseInfo(ICaseListArray uscisCase) {
            ...
            //_UserField = uscisCase.GetUserField();

            //_ResponseCode = uscisCase.GetResponseCode();
            _ResponseCode = uscisCase.GetMessageCode();
            //_ResponseStatement = uscisCase.GetResponseStatement();
            _ResponseStatement = uscisCase.GetEligibility();


            //_ResolveDate = Convert.ToDateTime(uscisCase.GetResolveDate());
            DateTime.TryParse(uscisCase.GetResolveDate(), out _ResolveDate);

            _ResolutionCode = uscisCase.GetResolutionCode();
        ...
        public string ResolutionCode {  get { return _ResolutionCode;  } }
