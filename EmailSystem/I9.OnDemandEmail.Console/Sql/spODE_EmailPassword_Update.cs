...
namespace I9.OnDemandEmail.Console.Sql {
    ...
    internal class spODE_EmailPassword_Update : FdblSql {

        #region Constructors

        internal spODE_EmailPassword_Update(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spODE_EmailPassword_Update", CommandType.StoredProcedure, true);
