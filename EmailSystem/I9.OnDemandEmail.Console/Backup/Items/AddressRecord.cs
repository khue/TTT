...
namespace I9.OnDemandEmail.Console.Items {
    ...
    internal class AddressRecord {
        ...
        internal AddressRecord(Sql.spODE_EmailAddresses_Get spEmailAddressesGet) {

            if (spEmailAddressesGet == null) throw new ArgumentNullException("spODE_EmailAddresses_Get is null");
