...
namespace I9.OnDemandEmail.Console.Sql {
    ...
    internal class spODE_EmailAttachments_Get : FdblSql {

        #region Constructors

        internal spODE_EmailAttachments_Get(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spODE_EmailAttachments_Get", CommandType.StoredProcedure, true);
