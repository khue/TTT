...
namespace I9.OnDemandEmail.Console.Sql {
    ...
    internal class spODE_EmailAddresses_Get : FdblSql {

        #region Constructors

        internal spODE_EmailAddresses_Get(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spODE_EmailAddresses_Get", CommandType.StoredProcedure, true);
