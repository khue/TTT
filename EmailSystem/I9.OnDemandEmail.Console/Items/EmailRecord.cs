...
namespace I9.OnDemandEmail.Console.Items {
    ...
    internal class EmailRecord {
        ...
        private string _SentSender = null;
        private string _SentReplyTo = null;
        ...
        internal EmailRecord(EmailTemplate et, List<AddressRecord> al, XmlElement xes) {
            ...
            _SentSender = et.SendSender;
            _SentReplyTo = et.SendReplyTo;
            ...
            //vsts 39242 2/27/2019 kh - updated this if/else statements below to make sure we are tracking employeeid. The reason is so we can incorporate employeeid into emailqueue, so that the email will appear on eedp and ee email search pages.
            ...
            {
                _AgentId = Int32.Parse(id);
                try { _EmployeeId = Convert.ToInt32(FdblXmlFunctions.GetAttributeValue(xac, "FragId")); } catch {}
                try { _I9Id = Convert.ToInt32(FdblXmlFunctions.GetAttributeValue(xac, "CurrentI9Id")); } catch {}
            }
            ...
            if (fxnl != null && fxnl.Count > 0) {
                ...
                //10-23-2018 removing this restriction, so that passwords can be sent to agent and users as well.
                //if (et.IsNewEmployeeAgentUser || et.IsNewEmployeePassword) {
        ...
        public string SentSender {  get { return _SentSender; } }
        public string SentReplyTo {  get { return _SentReplyTo; } }
