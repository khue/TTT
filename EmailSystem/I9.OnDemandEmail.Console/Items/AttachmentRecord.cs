...
namespace I9.OnDemandEmail.Console.Items {
    ...
    internal class AttachmentRecord {
        ...
        internal AttachmentRecord(Sql.spODE_EmailAttachments_Get spEmailAttachmentsGet) {

            if (spEmailAttachmentsGet == null) throw new ArgumentNullException("spODE_EmailAttachments_Get is null");
