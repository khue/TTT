...
namespace I9.ScheduledEmail.Console.Sql {
    ...
    internal class spSE_QueueAttachment_Insert : FdblSql {

        #region Constructors

        internal spSE_QueueAttachment_Insert(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spSE_QueueAttachment_Insert", CommandType.StoredProcedure, true);
