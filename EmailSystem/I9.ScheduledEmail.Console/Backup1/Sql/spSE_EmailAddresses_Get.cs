...
namespace I9.ScheduledEmail.Console.Sql {
    ...
    internal class spSE_EmailAddresses_Get : FdblSql {

        #region Constructors

        internal spSE_EmailAddresses_Get(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spSE_EmailAddresses_Get", CommandType.StoredProcedure, true);
