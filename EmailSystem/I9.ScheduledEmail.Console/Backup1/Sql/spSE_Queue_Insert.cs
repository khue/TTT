...
namespace I9.ScheduledEmail.Console.Sql {
    ...
    internal class spSE_Queue_Insert : FdblSql {

        #region Constructors

        internal spSE_Queue_Insert(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spSE_Queue_Insert", CommandType.StoredProcedure, true);
