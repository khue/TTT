...
namespace I9.ScheduledEmail.Console.Sql {
    ...
    internal class spSE_EmailTemplates_Get : FdblSql {

        #region Constructors

        internal spSE_EmailTemplates_Get(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spSE_EmailTemplates_Get", CommandType.StoredProcedure, true);
