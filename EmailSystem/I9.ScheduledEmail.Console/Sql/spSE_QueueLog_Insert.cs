...
namespace I9.ScheduledEmail.Console.Sql {
    ...
    internal class spSE_QueueLog_Insert : FdblSql {

        #region Constructors

        internal spSE_QueueLog_Insert(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spSE_QueueLog_Insert", CommandType.StoredProcedure, true);
