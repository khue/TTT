...
namespace I9.USCIS.Wrapper.Sql
{
    internal class spUSCIS_OnDemandEmail_Insert : FdblSql {
        ...
        public int StartDataReader(int idEmailTemplateType, int idEmployee, int idI9)
        {
            ...
            if ((idEmailTemplateType < 8 || idEmailTemplateType > 67) && idEmailTemplateType != -1) throw new ArgumentException("Email Template Type is invalid. Type: " + idEmailTemplateType);
