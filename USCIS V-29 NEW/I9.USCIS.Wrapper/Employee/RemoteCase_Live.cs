...
namespace I9.USCIS.Wrapper.Employee {
    ...
    internal class RemoteCase_Live : RemoteCase {

        #region Constructors

        internal RemoteCase_Live(GetCaseDetailsResult uscisResponse) {
            ...
            _InsReferoResolvedDt = Convert.ToDateTime(uscisResponse.ReferralResponseDueDate);
            ...
            _SsaReferralRespDueDate = Convert.ToDateTime(uscisResponse.ReferralResponseDueDate);
