...
namespace I9.USCIS.Wrapper.WebService {
    ...
    public class Request_Test : Request, IRequest {

        #region Members

        private EmployerWebServiceV29 _USCISWebService;
        
        private Response_Test _Response;

        #endregion

        #region Constructors

        public Request_Test() : this(Request.BypassId, Request.BypassId) { }

        public Request_Test(int idEmployee, int idI9) {
            ...
            _Configuration = new USCISConfiguration(USCISSystemId.Test);

            _Pids = new ProcessIds(_Configuration.Logs.Capture);

            _Pids.CategoryId = USCISCategoryId.Internal;
            _Pids.SystemId = USCISSystemId.Test;
            ...
            //        response = new Response_Test(_Pids.RequestId, _USCISWebService.EmpCpsVerifyConnection());
        ...
        public bool EmpGetCaseDetails() {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++) {
                ...
                try {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.GetCaseDetails(r));
        ...
        public bool EmpGetDuplicateCaseList()
        {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++)
            {
                ...
                try
                {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.GetDuplicateCaseList(r));
                    _Pids.ResponseId = base.InsertResponse(response, _Pids.CaseNumber);
        ...
        public bool GetNextCase() {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++) {
                ...
                try {
                    ...
                    //response = new Response_Test(_Pids.RequestId, _USCISWebService.EmpGetNextResolvedCaseNbrs( _Version, "1", "Y"));
                    GetResolvedCasesRequest r = new GetResolvedCasesRequest();
                    r.NumberOfRecords = 1;

                    response = new Response_Test(_Pids.RequestId, _USCISWebService.GetResolvedCases(r));
        ...
        public bool AcknowledgeReceiptOfCaseNumber(USCISAcknowledgeCase ac) {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++) {
                ...
                try {
                    ...
                    r.CaseList[0] = nbr;
                    if (response == null) response = new Response_Test(_Pids.RequestId, _USCISWebService.ConfirmResolvedCasesReceived(r));
        ...
        public bool InitiateCase() {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++) {
                ...
                try {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.SubmitInitialVerification(r));
            ...
            else
            {
                ...
                //base.QueueAsError(USCISActionId.InitiateCase, USCISClosureId.None, null, rawData, idErrorRequests, response, null);
             }
        ...
        public bool SubmitSSAReferral() {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++) {
                ...
                try {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.SubmitSsaReferral(r));
            ...
            else
            {
                ...
                base.UpdateTransaction((response == null ? USCISCaseStatus.Unknown : response.CaseStatusEnum), USCISProcessStatus.ManualInterventionRequired, null);
                //base.QueueAsError(USCISActionId.SubmitSSAReferral, USCISClosureId.None, null, rawData, idErrorRequests, response, null);
            }
        ...
        public bool EmpRetrieveFAN(string LetterTypeCode)
        {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++)
            {
                ...
                try
                {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.RetrieveLetter(r));

                    _Pids.ResponseId = base.InsertResponse(response, _Pids.CaseNumber);

                    status = true;

                    //response doesn't have a casenbr field. need to set it
                    if (_Pids.CaseNumber != null)
                    {
            ...
            else
            {
                ...
                base.UpdateTransaction((response == null ? USCISCaseStatus.Unknown : response.CaseStatusEnum), USCISProcessStatus.ManualInterventionRequired);
                //base.QueueAsError(USCISActionId.EmpRetrieveFAN, USCISClosureId.None, null, rawData, idErrorRequests, response, null);
            }
        ...
        public bool ResubmitSSAVerification() {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++) {
                ...
                try {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.SubmitSsaResubmittal(r));
        ...
        public bool SubmitDHSReferral() {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++) {
                ...
                try {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.SubmitDhsReferral(r));
        ...
        public bool SubmitSecondVerification(string comments) {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++) {
                ...
                try {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.SubmitAdditionalVerification(r));
        ...
        public bool CloseCase(USCISClosureId idClosure, string currentlyEmployed) {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++) {
                ...
                try {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.CloseCase(r));
        ...
        public bool EmpConfirmPhoto()
        {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++)
            {
                ...
                try
                {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.ConfirmDocumentPhoto(r));
        ...
        public bool EmpSSAReVerify()
        {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++)
            {
                ...
                try
                {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.SubmitSsaReverify(r));
        ...
        public bool EmpDHSReVerify()
        {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++)
            {
                ...
                try
                {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.SubmitDhsReverify(r));
        ...
        public bool EmpRetrievePhoto()
        {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++)
            {
                ...
                try
                {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.RetrieveDocumentPhoto(r));
        ...
        public bool EmpDupCaseContinueWithChanges()
        {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++)
            {
                ...
                try
                {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.ContinueDuplicateCaseWithChange(r));
        ...
        public bool EmpDupCaseContinueWithoutChanges()
        {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++)
            {
                ...
                try
                {
                    ...
                    response = new Response_Test(_Pids.RequestId, _USCISWebService.ContinueDuplicateCase(r));
        ...
        public bool EmpSaveSSATNCNotification()
        {
            ...
            for (int i = 0; i < _Configuration.CPS.AttemptMaxRetry; i++)
            {
                ...
                try
                {
                    ...
                    response = new Response_Test(_Pids.RequestId, 0);
