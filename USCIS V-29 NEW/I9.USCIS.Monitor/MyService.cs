...
namespace I9.USCIS.Monitor {
    ...
    public partial class MyService : ServiceBase {
            ...
            try {
                ...
                try {
                    ...
                    while (spMonitorGet.MoveNextDataReader(true)) {
                        ...
                        if (idConsole != -1) {
                            //added pid and threadid to log so I can review the process.
                            _ServiceLog.WriteEntry(string.Format("Starting console for id: {0} PID: {1}, Thread: {2}", idConsole, Process.GetCurrentProcess().Id, Thread.CurrentThread.ManagedThreadId), EventLogEntryType.Information, 5000);
        ...
        private void _ServiceLog_EntryWritten(object sender, EntryWrittenEventArgs e)
        {
