...
namespace I9.USCIS.FQueue.Live.Sql {
    ...
    internal class spUSCISBE_QueueFuture_Complete : FdblSql {

        #region Constructors

        public spUSCISBE_QueueFuture_Complete(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spUSCISBE_QueueFuture_Complete", CommandType.StoredProcedure, true);
