...
namespace I9.USCIS.FQueue.Test.Sql {
    ...
    internal class spUSCISBE_QueueFuture_Begin : FdblSql {

        #region Constructors

        public spUSCISBE_QueueFuture_Begin(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spUSCISBE_QueueFuture_Begin", CommandType.StoredProcedure, true);
