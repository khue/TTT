...
namespace I9.USCIS.EQueue.Test.Sql {
    ...
    internal class spUSCISBE_QueueError_Begin : FdblSql {

        #region Constructors

        public spUSCISBE_QueueError_Begin(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spUSCISBE_QueueError_Begin", CommandType.StoredProcedure, true);
