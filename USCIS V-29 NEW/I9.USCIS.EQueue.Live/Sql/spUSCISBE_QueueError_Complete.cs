...
namespace I9.USCIS.EQueue.Live.Sql {
    ...
    internal class spUSCISBE_QueueError_Complete : FdblSql {

        #region Constructors

        public spUSCISBE_QueueError_Complete(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spUSCISBE_QueueError_Complete", CommandType.StoredProcedure, true);
