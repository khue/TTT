...
namespace I9.USCIS.EQueue.Live.Wrapper {
    ...
    internal class EmploymentVerification {
        ...
        public bool AutoProcessInitiateCase() {
            ...
            if (!_Request.CloseCase(USCISClosureId.EAUTH)) return false;
        ...
        public bool CloseCase(int idClosure, string caseNumber) {
            ...
            if (!_Request.CloseCase(_ConvertToUSCISClosureId(idClosure))) return false;
