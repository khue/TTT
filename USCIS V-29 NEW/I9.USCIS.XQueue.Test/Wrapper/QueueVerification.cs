...
namespace I9.USCIS.XQueue.Test.Wrapper {
    ...
    internal class QueueVerification {
        ...
        public bool ProcessNextCase() {
            ...
            for (int i = 0; i < _Request.WebServiceResponse.NumberOf; i++) {
                ...
                //bool x = _Request.AcknowledgeReceiptOfCaseNumber(ci.CaseNumber);
                ...
                try {
                    ...
                    if (ci.TypeOfCase.Equals("1")) { // SSA Response
                        ...
                        else if (tmpCode.Equals("030"))
                        {
                            ...
                            CheckAndSendEmail((int)OnDemandEmailCodes.Code_030, _Request.EmployeeId, _Request.I9Id);
                        ...
                        else if (tmpCode.Equals("042"))
                        {

                            _Request.UpdateTransaction(USCISCaseStatus.Code_42, USCISProcessStatus.AwaitingUSCIS);
                            CheckAndSendEmail((int)OnDemandEmailCodes.Code_42, _Request.EmployeeId, _Request.I9Id);

                        }
                        else if (tmpCode.Equals("043"))
                        {

                            _Request.UpdateTransaction(USCISCaseStatus.Code_43, USCISProcessStatus.ClosingCase);
                            CheckAndSendEmail((int)OnDemandEmailCodes.Code_43, _Request.EmployeeId, _Request.I9Id);

                            bool isClosed = _Request.CloseCase(USCISClosureId.TECISS, "Y");

                            if (!isClosed) _Request.UpdateTransaction(USCISCaseStatus.Code_43, USCISProcessStatus.CaseNeedsClose);
                        ...
                        if (tmpCode.Equals("i")) {
                         ...
                         } else if (tmpCode.Equals("p")) {

                            _Request.UpdateTransaction(USCISCaseStatus.Code_P, USCISProcessStatus.AwaitingClient);
                            CheckAndSendEmail((int)OnDemandEmailCodes.Code_P, _Request.EmployeeId, _Request.I9Id);

                        }

                         else if (tmpCode.Equals("x")) {

                            _Request.UpdateTransaction(USCISCaseStatus.Code_X, USCISProcessStatus.AwaitingClient);
                            CheckAndSendEmail((int)OnDemandEmailCodes.Code_X, _Request.EmployeeId, _Request.I9Id);
