...
namespace I9.USCIS.Console.Sql {
    ...
    internal class spUSCISBE_Console_Begin : FdblSql {

        #region Constructors

        public spUSCISBE_Console_Begin(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spUSCISBE_Console_Begin", CommandType.StoredProcedure, true);
