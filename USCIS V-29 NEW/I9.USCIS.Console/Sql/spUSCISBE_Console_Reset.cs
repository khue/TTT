...
namespace I9.USCIS.Console.Sql {
    ...
    internal class spUSCISBE_Console_Reset : FdblSql {

        #region Constructors

        public spUSCISBE_Console_Reset(string sqlConnectionInfo) : base(sqlConnectionInfo) {

            AutoConnect = true;

            OpenCommand("spUSCISBE_Console_Reset", CommandType.StoredProcedure, true);
